...
Welcome to the Mintlify documentation guide. Follow the instructions below to learn how to deploy, update and supercharge your documentation with Mintlify. Don't want to convert your docs just yet? Use our starter template to get started.

### 1. Deploying Your Docs Repository

Mintlify docs are rendered from [MDX](https://www.markdownguide.org/getting-started/#what-is-markdown) files and configurations defined in our [starter template](https://github.com/mintlify/starter). We use Github to integrate your docs with your code, and make source control effortless.
...
<AccordionGroup>
  <Accordion icon="code-branch" title="Generating API References">
    ...
    2. Use our [scraper](/api-playground/setup/openapi/setup#autogenerate-files-recommended) to autogenerate your OpenAPI endpoints files as:
    ...
    For a complete guide on using Mintlify with OpenAPI, check out [this guide](/api-playground/setup/openapi/setup). [This guide](/api-playground/setup/openapi/writing-openapi) explains how to configure your API authentication methods. For manual API references definition, explore [our syntax](/api-playground/overview).
